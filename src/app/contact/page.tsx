    ...
    <main className="min-h-screen bg-white">
      <section className="container mx-auto max-w-6xl px-4 py-6 sm:py-10">
        ...
        <div className="mt-6 sm:mt-10 grid grid-cols-1 gap-4 sm:gap-6 sm:grid-cols-2 lg:grid-cols-3">
          {/* Call */}
          <div className="rounded-2xl bg-white p-4 sm:p-6 shadow-sm ring-1 ring-slate-200 text-center sm:text-left">
        ...
        <div className="mt-6 sm:mt-10 rounded-2xl bg-white p-4 shadow-sm ring-1 ring-slate-200">
          <h2 className="px-2 text-lg font-semibold text-slate-900 text-center sm:text-left">Location</h2>
          <div className="mt-3 sm:mt-4">
            <iframe
