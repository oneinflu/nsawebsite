...
const CIAComparison = () => {
  ...
  const comparisonData = {
    ...
    'Global Acceptance': {
      CIA: { value: '✅✅', score: 10, detail: '190+ countries', color: 'text-green-600' },
      CA: { value: 'Low', score: 4, detail: 'India & Commonwealth', color: 'text-red-600' },
      CPA: { value: '✅', score: 9, detail: '100+ countries', color: 'text-green-600' },
      CMA: { value: '✅', score: 8, detail: '100+ countries', color: 'text-green-600' }
    },
    'Career Focus': {
    ...
    'Experience Requirement': {
      ...
      CA: { value: '3 Years', score: 6, detail: 'Articleship mandatory', color: 'text-yellow-600' },
      CPA: { value: '1-2 Years', score: 9, detail: 'State dependent', color: 'text-green-600' },
      CMA: { value: '2 Years', score: 8, detail: 'Management experience', color: 'text-green-600' }
    }
  };
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-xl text-slate-600 max-w-3xl mx-auto">
            See how CIA compares with CA, CPA, and CMA across key factors that matter for your career
          </p>
        </motion.div>
          ...
          <div className="divide-y divide-slate-200">
            {features.map((feature, index) => (
              ...
              >
                ...
                {certifications.map((cert) => {
                  const data = comparisonData[feature as keyof typeof comparisonData][cert as keyof typeof comparisonData[keyof typeof comparisonData]];
                  ...
                  return (
                    ...
                    >
                      ...
                      {hoveredCell === cellKey && (
                        ...
                        >
                          <div className="text-sm font-semibold">Score: {data.score}/10</div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
          {ciaAdvantages.map((advantage, index) => (
            ...
            >
              <div className={`w-12 h-12 bg-gradient-to-r ${advantage.color} rounded-xl flex items-center justify-center mb-4 group-hover:scale-110 transition-transform duration-300`}>
        ...
        <motion.div
          ...
          whileInView={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.6 }}
          className="bg-gradient-to-r from-green-600 to-emerald-600 rounded-3xl p-8 text-white text-center mb-16"
        >
          <div className="text-6xl mb-4">🏆</div>
          <h3 className="text-3xl font-bold mb-4">CIA: The Clear Winner for Internal Audit</h3>
        ...
        >
          <div className="max-w-3xl mx-auto">
            ...
            <h3 className="text-3xl font-bold mb-4">Not Sure Which Path is Right for You?</h3>
            <p className="text-xl opacity-90 mb-8">
              Take our personalized Career Path Quiz and get a customized recommendation 
            ...
            <div className="mt-6 text-sm opacity-75">
              ⚡ Get results in 2 minutes • 🎯 Personalized recommendations • 📊 Career roadmap included
            </div>
          </div>
        </motion.div>
      </div>
