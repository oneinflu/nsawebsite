  ...
  const personas = [
    {
      ...
      description: "Fresh graduates looking to build a specialized career in internal auditing",
      benefits: [
    ...
    },
    {
      ...
      description: "Experienced professionals wanting to specialize and advance in internal audit",
      benefits: [
    ...
    },
    {
      ...
      description: "Chartered accountants seeking to add risk management and internal audit expertise",
      benefits: [
    ...
    },
    {
      ...
      description: "IT professionals working in controls, compliance, and SOX implementations",
      benefits: [
  ...
  const microNudges = [
    {
      ...
      subtext: "Transform your current skills into internationally recognized expertise"
    },
    {
      icon: StarIcon,
        ...
        >
          {personas.map((persona, index) => (
            ...
            >
              ...
              <div className={`absolute inset-0 bg-gradient-to-br ${persona.bgColor} rounded-3xl opacity-0 group-hover:opacity-100 transition-opacity duration-300`}></div>
              
              <div className="relative z-10 h-full flex flex-col">
                {/* Icon & Emoji */}
                <div className="flex items-center justify-center mb-4">
                  <div className={`p-3 rounded-2xl bg-gradient-to-r ${persona.color} mr-3`}>
                ...
                <div className="text-center mb-4">
                  ...
                  <p className={`text-sm font-semibold bg-gradient-to-r ${persona.color} bg-clip-text text-transparent`}>
                    {persona.subtitle}
                  </p>
                </div>
                ...
                <div className="space-y-2 mb-4">
                  <div className="flex justify-between items-center text-xs">
                    ...
                    <span className="font-semibold text-gray-700">{persona.timeline}</span>
                  </div>
                  <div className="flex justify-between items-center text-xs">
                    <span className="text-gray-500">Salary Range:</span>
                    <span className={`font-bold bg-gradient-to-r ${persona.color} bg-clip-text text-transparent`}>
                      {persona.salaryRange}
                    </span>
                  </div>
                </div>
