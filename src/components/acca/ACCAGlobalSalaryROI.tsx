      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <div className="flex items-center justify-center mb-6">
            <GlobeAltIcon className="w-8 h-8 md:w-12 md:h-12 text-red-600 mr-4" />
          ...
          <p className="text-md md:text-xl text-gray-600 max-w-3xl mx-auto">
            Discover your earning potential across different regions and
        ...
        <AnimatePresence mode="wait">
          ...
          >
            {/* Salary Ranges */}
            <div className="bg-white rounded-3xl p-4 md:p-8 shadow-lg border border-gray-200">
              ...
              <div className="space-y-4">
                {regions[activeRegion as keyof typeof regions].salaryRanges.map(
                  (item, index) => (
                    <motion.div
                      key={index}
                      initial={{ opacity: 0, x: -20 }}
              ...
              <div className="mt-6 p-4 bg-red-600  rounded-xl text-white text-center">
            ...
            <div className="space-y-6">
              ...
              <div className="bg-white rounded-3xl p-4 md:p-8 shadow-lg border border-gray-200">
                ...
                <div className="grid grid-cols-2 gap-4">
                  {regions[activeRegion as keyof typeof regions].topRoles.map(
                    (role, index) => (
                      <motion.div
                        key={index}
              ...
              <div className="bg-white rounded-3xl p-8 shadow-lg border border-gray-200">
                ...
                <div className="relative">
                  {regions[activeRegion as keyof typeof regions].salaryRanges
                    .slice()
                    .reverse()
                    .map((item, index) => (
                      <motion.div
