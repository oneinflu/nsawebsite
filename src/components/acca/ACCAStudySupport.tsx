      ...
      visual: (
        <div className="relative">
          <div className="bg-gray-900 rounded-lg p-4 shadow-lg">
            ...
            <div className="bg-blue-600 rounded p-3 mb-2">
          ...
          <div className="space-y-3">
            ...
            <div className="flex items-start justify-end">
              <div className="flex-1 text-right">
                <div className="bg-blue-500 text-white rounded-lg p-2 text-sm inline-block">
        ...
        >
          <div className="flex items-center justify-center mb-6">
            ...
            <h2 className="text-4xl md:text-5xl font-bold text-gray-900">
              NorthStar <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-purple-600">Experience</span>
            </h2>
          </div>
