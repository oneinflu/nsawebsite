...
const PortraitVideoCarousel: React.FC<Props> = ({
  videos,
      ...
      <div className="relative max-w-6xl mx-auto px-4">
        ...
        >
          {items.map((item, idx) => (
            ...
            >
              <div
                className={`relative w-full h-full rounded-2xl overflow-hidden shadow-lg bg-gradient-to-br ${
              ...
              >
                ...
                {item.quote && (
                  <div className="absolute top-3 left-3 right-3 text-center">
                    <p
                      className={`${playfair.className} text-white/95 text-[17px] sm:text-[19px] leading-tight drop-shadow-md line-clamp-2`}
                    >
                      {item.quote}
                    </p>
                  </div>
