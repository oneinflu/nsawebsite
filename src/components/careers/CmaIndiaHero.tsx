        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-center">
          <div className="lg:col-span-2">
            ...
            <p className="mt-3 text-lg text-slate-700">
              Step into FP&A, cost management, finance leadership and controllership roles across India’s top MNCs and shared service centres.
            </p>
            ...
            <div className="mt-6 flex flex-wrap gap-3">
              <div className="inline-flex items-center gap-2 rounded-xl bg-gradient-to-br from-indigo-600 to-purple-600 px-4 py-2 text-white shadow">
                ...
                In-demand across manufacturing, IT services, e‑commerce, and BFSI
              </div>
          ...
          <div className="lg:col-span-1">
            <div className="rounded-2xl ring-1 ring-slate-200 bg-gradient-to-br from-slate-50 to-white p-6 shadow-sm">
              <div className="flex flex-wrap gap-2">
                {['Mumbai','Bengaluru','Gurugram','Pune','Hyderabad'].map((c) => (
              ...
              <div className="mt-4 grid grid-cols-2 gap-3 text-center">
                <div className="rounded-xl bg-slate-50 p-3 ring-1 ring-slate-200">
                  ...
                  <div className="font-semibold text-slate-900">Cost & FP&A</div>
                </div>
                <div className="rounded-xl bg-slate-50 p-3 ring-1 ring-slate-200">
                  <div className="text-sm text-slate-600">Path</div>
                  <div className="font-semibold text-slate-900">Manager → Controller</div>
                </div>
              </div>
            </div>
          </div>
