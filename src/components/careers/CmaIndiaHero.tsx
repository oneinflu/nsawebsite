        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-center">
          <div className="lg:col-span-2 text-center md:text-left">
            <h1 className="text-2xl md:text-4xl font-extrabold tracking-tight text-slate-900">
              CMA (US) in India — Build a High-Growth Finance Career
            </h1>
            <p className="mt-3 text-md md:text-lg text-slate-700">
              Step into FP&A, cost management, finance leadership and
              controllership roles across India’s top MNCs and shared service
              centres.
            </p>

            <div className="mt-6 flex flex-wrap gap-3 text-sm md:text-lg">
              <div className="inline-flex items-center gap-2 rounded-xl bg-gradient-to-br from-indigo-600 to-purple-600 px-4 py-2 text-white shadow">
                ...
                In-demand across manufacturing, IT services, e‑commerce, and
                BFSI
              </div>
              <div className="inline-flex items-center gap-2 rounded-xl bg-gradient-to-br from-emerald-500 to-teal-600 px-4 py-2 text-white shadow">
                ...
                Mumbai • Bengaluru • Gurugram • Pune • Hyderabad
              </div>
            </div>
            ...
            <div className="mt-6 flex flex-wrap gap-3">
              ...
              >
                Explore CMA (US) Course & Eligibility →
              </Link>
            </div>
          </div>
          ...
          <div className="lg:col-span-1">
            <div className="rounded-2xl ring-1 ring-slate-200 bg-gradient-to-br from-slate-50 to-white p-6 shadow-sm">
              <div className="flex flex-wrap gap-2">
                {["Mumbai", "Bengaluru", "Gurugram", "Pune", "Hyderabad"].map(
                  (c) => (
                    <span
                      key={c}
                      className="inline-flex items-center rounded-full bg-slate-100 px-3 py-1 text-sm text-slate-800 ring-1 ring-slate-200"
                    >
                      {c}
                    </span>
                  )
