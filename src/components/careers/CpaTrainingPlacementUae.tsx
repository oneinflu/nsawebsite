      ...
      <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8 py-12">
        <header className="mb-6 text-center md:text-left">
          <h2 className="text-2xl md:text-3xl font-bold text-slate-900">
            How Your CPA (US) Qualification Becomes a UAE Finance Career
          </h2>
        </header>
          ...
          <div className="lg:col-span-2">
            <ul className="space-y-4">
              {bullets.map((text) => (
                <li key={text} className="flex items-start gap-3">
                  ...
                  <span className="text-sm md:text-md text-slate-800">{text}</span>
                </li>
              ))}
            </ul>
            ...
            <div className="mt-6 flex flex-wrap gap-3">
              <a
                ...
                className="text-sm md:text-md inline-flex items-center justify-center rounded-xl bg-gradient-to-br from-indigo-600 to-purple-600 px-5 py-3 text-white shadow hover:from-indigo-700 hover:to-purple-700 focus:outline-none focus:ring-2 focus:ring-indigo-500"
              >
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  <p className="text-slate-900">
                    “I cleared my CPA and within 6 months landed an FP&A role in
                    Dubai”
                  </p>
