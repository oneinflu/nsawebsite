...
const CmaTrainingPlacementIndia = () => {
  return (
    <section className="relative bg-white">
      <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8 py-12">
        <header className="mb-6">
          <h2 className="text-2xl md:text-3xl font-bold text-slate-900">Training + Placement Support</h2>
          <p className="mt-2 text-slate-600">Finish CMA (US) exams and move into FP&A, cost, and controllership roles in India.</p>
        </header>
          ...
          <div className="rounded-2xl bg-white p-6 ring-1 ring-slate-200 shadow-sm">
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <div className="mt-1 text-sm text-slate-700">Study plan, concept clarity, and exam strategies for Parts 1 & 2.</div>
              </div>
            </div>
          </div>
          ...
          <div className="rounded-2xl bg-white p-6 ring-1 ring-slate-200 shadow-sm">
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <div className="mt-1 text-sm text-slate-700">Profile building, role targeting, and interview practice for India hubs.</div>
              </div>
            </div>
          </div>
          ...
          <div className="rounded-2xl bg-white p-6 ring-1 ring-slate-200 shadow-sm">
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <div className="mt-1 text-sm text-slate-700">Guided transition into FP&A, cost, reporting, and controls roles.</div>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="mt-8 rounded-2xl ring-1 ring-slate-200 p-6 bg-gradient-to-br from-slate-50 to-white">
          <blockquote className="text-slate-800">
            “The CMA (US) pathway gave me clarity and the right entry point into FP&A in Bengaluru. The structured support made all the difference.”
          </blockquote>
...
export default CmaTrainingPlacementIndia;