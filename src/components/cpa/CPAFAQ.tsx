    ...
    recognition: [
      {
        ...
        answer:
          "Yes, CPA is globally recognized and highly valued. It's accepted in 180+ countries and is particularly prestigious in the US, Canada, Australia, and many multinational corporations worldwide.",
      ...
      },
      {
        ...
        answer:
          "CPA is accepted in major economies including USA, Canada, Australia, UK, Singapore, Hong Kong, UAE, India, and most EU countries. Many countries have mutual recognition agreements with US CPA boards.",
      ...
      },
      {
        ...
        answer:
          "Absolutely. Deloitte, EY, PwC, and KPMG strongly prefer CPA certification for their US operations and international assignments. CPA holders often get faster promotions and higher starting salaries.",
      ...
      },
      {
        ...
        answer:
          "While CA and ACCA are respected, CPA has broader global recognition, especially in multinational corporations. CPA holders typically earn 15-25% more than CA/ACCA holders in similar roles.",
      ...
      },
      {
        ...
        answer:
          "Yes, US CPA is highly valued in India. You can work in MNCs, Big 4 firms, financial services, and consulting. However, for statutory audit in India, you'll need additional local certifications.",
    ...
    evaluation: [
      {
        ...
        answer:
          "The evaluation involves: 1) Educational qualification assessment (150 credit hours), 2) Ethics exam completion, 3) Work experience verification (1-2 years), and 4) Application to state board for license.",
      ...
      },
      {
        ...
        answer:
          "Requirements vary by state. Some states allow you to sit with 120 credit hours but require 150 for licensure. Popular states like California, Texas, and New York have different requirements.",
      ...
      },
      {
        ...
        answer:
          "Foreign degrees are evaluated by NASBA-approved agencies like FACS, ERES, or IQAS. They assess if your education meets US accounting course requirements and credit hour equivalency.",
      ...
      },
      {
        ...
        answer:
          "You can complete additional courses through US universities, community colleges, or online programs. Many candidates take courses in accounting, business law, and ethics to meet requirements.",
      ...
      },
      {
        ...
        answer:
          "Educational evaluation typically takes 4-8 weeks. The entire process from application to receiving NTS (Notice to Schedule) can take 2-3 months depending on the state.",
    ...
    attempts: [
      {
        ...
        answer:
          "There's no limit on attempts, but you must wait until the next testing window if you fail. You can retake sections as many times as needed within the 18-month rolling period.",
      ...
      },
      {
        ...
        answer:
          "You must pass all 4 sections within 18 months of passing your first section. If you don't, the earliest passed sections will expire and you'll need to retake them.",
      ...
      },
      {
        ...
        answer:
          "Individual section scores are valid for 18 months from the date you passed. You must complete all sections within this rolling 18-month window to maintain your passing scores.",
      ...
      },
      {
        ...
        answer:
          "Yes, you can retake any section even with a score of 74 (just below the 75 passing score). Many candidates retake sections to improve their scores or if they're close to passing.",
      ...
      },
      {
        ...
        answer:
          "You must wait until the next testing window opens. Testing windows are typically 2 months long with 1-2 week breaks between them. Plan your retakes accordingly.",
    ...
    prometric: [
      {
        ...
        answer:
          "CPA exams are conducted at Prometric testing centers. There are 300+ centers across the US and international locations in Japan, Europe, Middle East, and select other countries.",
      ...
      },
      {
        ...
        answer:
          "Yes, international Prometric centers are available in Japan, Germany, UK, UAE, Bahrain, Kuwait, Lebanon, and Brazil. More locations are being added regularly.",
      ...
      },
      {
        ...
        answer:
          "After receiving your NTS, visit prometric.com/cpa to schedule. You can choose date, time, and location. Book early as popular slots fill up quickly, especially in major cities.",
      ...
      },
      {
        ...
        answer:
          "Bring two forms of valid ID (passport, driver's license, etc.) and your NTS. No personal items allowed in testing room - Prometric provides calculator, scratch paper, and noise-canceling headphones.",
      ...
      },
      {
        ...
        answer:
          "Yes, you can reschedule up to 24 hours before your appointment without penalty. Changes within 24 hours or no-shows result in forfeiture of exam fees.",
      ...
      },
      {
        ...
        answer:
          "All sections are computer-based with multiple choice questions, task-based simulations, and written communication tasks (BEC only). Exam duration varies: AUD/FAR (4 hours), BEC/REG (4 hours).",
    ...
    <section className="py-8 md:py-20 bg-gradient-to-br from-gray-50 to-red-50 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        ...
        <div className="text-center mb-16">
          ...
          >
            Get answers to the most common questions about CPA recognition,
            evaluation process, exam attempts, and Prometric testing details
          </motion.p>
        ...
        >
          ...
          <p className="text-lg opacity-90 mb-6">
            Get personalized answers from our CPA experts and start your journey
            today
          </p>
