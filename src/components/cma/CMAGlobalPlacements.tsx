...
const CMAGlobalPlacements = () => {
  ...
  return (
    <section className="py-20 bg-gradient-to-br from-red-50 via-red-50 to-red-50">
        ...
        >
          <div className="flex items-center justify-center mb-6">
            ...
            <h2 className="text-4xl md:text-5xl font-bold text-gray-900">
              Where Our <span className="text-transparent bg-clip-text bg-gradient-to-r from-red-600 to-red-500">CMAs Work Today</span>
            </h2>
          </div>
          ...
          <div className="relative overflow-hidden">
            ...
            >
              {[...companies, ...companies].map((company, index) => (
                <div
                  key={index}
                  className="flex-shrink-0 relative w-40 h-20"
                >
                  <Image
                    src={company.logo}
                    alt={company.name}
                      ...
                      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                        ...
                        <div className="space-y-6">
                          <div className="flex items-center space-x-4">
                            <div className="w-16 h-16 bg-gradient-to-br from-red-100 to-red-100 rounded-full flex items-center justify-center">
                          ...
                          <div className="bg-gradient-to-r from-green-50 to-red-50 rounded-2xl p-6 border border-green-200">
                            ...
                            <div className="space-y-2">
                              <div className="flex justify-between">
                                ...
                                <span className="font-medium text-black">{offer.company}</span>
                              </div>
                              <div className="flex justify-between">
                                <span className="text-gray-600">Position:</span>
                                <span className="font-medium text-black">{offer.position}</span>
                              </div>
                              <div className="flex justify-between">
                                <span className="text-gray-600">Joining:</span>
                                <span className="font-medium text-black">{offer.joiningDate}</span>
                              </div>
                            </div>
                          </div>
                            ...
                            <div className="bg-white rounded-2xl shadow-2xl border-2 border-gray-200 overflow-hidden">
                              <div className="relative w-full h-72 md:h-96">
                                <Image
                                  ...
                                  priority={offer.id === 1}
                                />
                                <div className="absolute bottom-3 right-3 bg-white/90 backdrop-blur px-4 py-2 rounded-xl shadow flex items-center space-x-2">
