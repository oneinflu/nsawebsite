            ...
            <div className="grid lg:grid-cols-3 md:grid-cols-2 gap-8">
              ...
              <div className="lg:col-span-2">
                <div className="flex items-center mb-6">
                  <div className="w-12 h-12 bg-gradient-to-r from-red-500 to-red-500 rounded-xl flex items-center justify-center mr-4">
                    <span className="text-white font-bold text-xl">N</span>
                  </div>
                  <div>
                    <h3 className="text-2xl font-bold text-white">NorthStar Academy</h3>
                    <p className="text-red-300 text-sm font-medium">Global Finance Careers Made in India</p>
                  </div>
                </div>
