...
export default function LeadMagnet() {
  ...
  return (
    <section className="py-6 sm:py-20 bg-gray-50 text-gray-900">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        ...
        >
          ...
          <h2 className="text-2xl sm:text-3xl md:text-4xl font-semibold mb-4">Helpful Tools To Start Your Finance Journey</h2>
        ...
        <motion.div 
          ...
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true }}
          className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 lg:mb-14 mb-8 items-stretch"
        >
        ...
        <motion.div 
          ...
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true }}
          className="rounded-xl p-6 lg:mb-14 mb-8 bg-white border border-gray-200"
        >
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-2 sm:gap-4">
              <a
                ...
                className="inline-flex items-center px-3 sm:px-4 py-2 sm:py-3  rounded-lg bg-red-600 hover:bg-red-700 text-white shadow-sm hover:shadow-md whitespace-nowrap text-sm"
              >
                <svg className="w-4 sm:w-5 h-4 sm:h-5 mr-1.5 sm:mr-2" fill="currentColor" viewBox="0 0 20 20">
              ...
              <a
                ...
                className="inline-flex items-center px-3 sm:px-4 py-2 sm:py-3  rounded-lg bg-green-600 hover:bg-green-700 text-white shadow-sm hover:shadow-md whitespace-nowrap text-sm"
              >
                <svg className="w-4 sm:w-5 h-4 sm:h-5 mr-1.5 sm:mr-2" fill="currentColor" viewBox="0 0 24 24">
        ...
        <motion.div 
          ...
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true }}
          className="rounded-xl p-6 lg:mb-14 mb-8  bg-white border border-gray-200 text-center"
        >
          <div className="flex items-center justify-center mb-4 flex-wrap gap-2">
            <h3 className="text-lg sm:text-2xl font-semibold"><span className="text-xl sm:text-2xl">🔥</span>Next Batch: Jan 15 — Only 13 seats left</h3>
          </div>
          
          <div className="flex justify-center items-center space-x-2 sm:space-x-4 mb-4">
            <div className="bg-gray-100 rounded-lg px-2 sm:px-4 py-2 min-w-[50px] sm:min-w-[60px]">
              <div className="text-xl sm:text-2xl font-semibold">{countdown.days.toString().padStart(2, '0')}</div>
              <div className="text-[10px] sm:text-xs text-gray-600">DAYS</div>
            </div>
            <div className="text-lg sm:text-2xl text-gray-400">:</div>
            <div className="bg-gray-100 rounded-lg px-2 sm:px-4 py-2 min-w-[50px] sm:min-w-[60px]">
              <div className="text-xl sm:text-2xl font-semibold">{countdown.hours.toString().padStart(2, '0')}</div>
              <div className="text-[10px] sm:text-xs text-gray-600"><span className="sm:hidden">HRS</span><span className="hidden sm:inline">HOURS</span></div>
            </div>
            <div className="text-lg sm:text-2xl text-gray-400">:</div>
            <div className="bg-gray-100 rounded-lg px-2 sm:px-4 py-2 min-w-[50px] sm:min-w-[60px]">
              <div className="text-xl sm:text-2xl font-semibold">{countdown.minutes.toString().padStart(2, '0')}</div>
              <div className="text-[10px] sm:text-xs text-gray-600"><span className="sm:hidden">MIN</span><span className="hidden sm:inline">MINS</span></div>
            </div>
            <div className="text-lg sm:text-2xl text-gray-400">:</div>
            <div className="bg-gray-100 rounded-lg px-2 sm:px-4 py-2 min-w-[50px] sm:min-w-[60px]">
              <div className="text-xl sm:text-2xl font-semibold">{countdown.seconds.toString().padStart(2, '0')}</div>
              <div className="text-[10px] sm:text-xs text-gray-600"><span className="sm:hidden">SEC</span><span className="hidden sm:inline">SECS</span></div>
            </div>
          </div>
        ...
        >
          <div className="bg-white rounded-2xl p-12 border border-gray-200">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-6">
              <LeadFormButton formType="general" variant="primary" className="md:px-8 px-1 md:py-4 py-1 md:text-lg text-sm">
