    ...
    <section className="py-16 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center">
          <h2 className="text-3xl sm:text-4xl font-bold text-slate-900">About NorthStar Academy</h2>
        ...
        <div className="mt-10 grid md:grid-cols-3 gap-6">
          {highlights.map((h, i) => (
            <div key={i} className="rounded-xl border border-slate-200 p-6 shadow-sm bg-gradient-to-br from-white to-slate-50">
        ...
        <div className="mt-12 grid md:grid-cols-3 gap-6">
          {stats.map((s, i) => (
            <div key={i} className="text-center rounded-xl border border-slate-200 bg-white p-6">
