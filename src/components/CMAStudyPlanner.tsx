...
export default function CMAStudyPlanner() {
    ...
    accelerated: [
      {
        ...
        hours: 40,
        activities: ["Video lectures", "Practice questions", "Case studies"],
      },
      {
        week: "Week 3-4",
        topic: "Planning, Budgeting, and Forecasting",
        hours: 45,
        activities: ["Interactive sessions", "Excel modeling", "Mock tests"],
      },
      {
        week: "Week 5-6",
        topic: "Performance Management",
        hours: 40,
        activities: ["Live classes", "Group discussions", "Assignments"],
      },
      {
        week: "Week 7-8",
        topic: "Cost Management",
        hours: 35,
        activities: ["Case analysis", "Problem solving", "Peer review"],
      },
      {
        week: "Week 9-10",
        topic: "Internal Controls",
        hours: 35,
        activities: ["Audit simulations", "Control testing", "Reports"],
      },
      {
        week: "Week 11-12",
        topic: "Technology and Analytics",
        hours: 35,
        activities: ["Data analysis", "Tech tools", "Final prep"],
      },
    ],
    standard: [
      {
        ...
        topic: "External Financial Reporting Decisions",
        hours: 60,
        activities: ["Comprehensive study", "Practice tests", "Doubt clearing"],
      },
      {
        week: "Month 2",
        topic: "Planning, Budgeting, and Forecasting",
        hours: 65,
        activities: ["Deep dive sessions", "Excel mastery", "Case studies"],
      },
      {
        week: "Month 3",
        topic: "Performance Management",
        hours: 60,
        activities: ["Performance metrics", "KPI analysis", "Mock exams"],
      },
      {
        week: "Month 4",
        topic: "Cost Management & Internal Controls",
        hours: 70,
        activities: ["Integrated learning", "Control frameworks", "Practice"],
      },
      {
        week: "Month 5",
        topic: "Technology and Analytics + Review",
        hours: 65,
        activities: ["Tech applications", "Final review", "Exam prep"],
      },
    ],
    flexible: [
      {
      ...
      },
      {
        ...
        topic: "Planning, Budgeting, and Forecasting",
        hours: 85,
        activities: ["Weekend sessions", "Online support", "Progress tracking"],
      },
      {
        week: "Month 5-6",
        topic: "Performance Management",
        hours: 80,
        activities: ["Evening classes", "Recorded sessions", "Peer groups"],
      },
      {
        week: "Month 7-8",
        topic: "Cost Management",
        hours: 75,
        activities: ["Flexible timing", "Mobile learning", "Quick reviews"],
      },
      {
        week: "Month 9-10",
        topic: "Internal Controls",
        hours: 75,
        activities: ["Weekend workshops", "Online labs", "Case discussions"],
      },
      {
        week: "Month 11-12",
        topic: "Technology and Analytics + Final Prep",
        hours: 85,
        activities: ["Intensive review", "Mock exams", "Exam strategy"],
      },
    ],
  };
  ...
  const studyResources = [
    {
      ...
      description: "200+ hours of comprehensive video content",
      color: "text-red-600 bg-red-50",
    },
    {
      icon: BookOpenIcon,
      title: "Study Materials",
      description: "IMA-aligned textbooks and practice guides",
      color: "text-red-600 bg-red-50",
    },
    {
      icon: DocumentTextIcon,
      title: "Practice Tests",
      description: "1000+ practice questions with explanations",
      color: "text-green-600 bg-green-50",
    },
    {
      icon: CalendarIcon,
      title: "Live Sessions",
      description: "Weekly live classes and doubt clearing",
  ...
  const currentSchedule =
    part1Schedule[selectedPlan as keyof typeof part1Schedule];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-xl text-slate-600 max-w-3xl mx-auto">
            Choose your ideal study track and get a personalized timeline to
            achieve your CMA certification goals efficiently.
          </p>
        </motion.div>
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="opacity-90">
                    Complete timeline for your CMA Part {selectedPart}{" "}
                    preparation
                  </p>
                </div>
        ...
        >
          <div className="bg-gradient-to-r from-red-50 to-red-50 rounded-2xl p-8 md:p-12">
            ...
            <p className="text-lg text-slate-600 mb-8 max-w-2xl mx-auto">
              Get your personalized study plan and start preparing for your CMA
              certification with our expert guidance and comprehensive
              resources.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <LeadFormButton
                formType="book-free-consultation"
                isSendOtp={true}
                variant="primary"
              >
