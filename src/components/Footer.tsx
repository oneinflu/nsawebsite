...
export default function Footer() {
  ...
  const socialLinks = [
    ...
    {
      name: "Facebook",
      href: "https://www.facebook.com/NorthStarAcad",
      icon: "facebook",
    },
    {
      name: "X (Twitter)",
          ...
          <div className="grid lg:grid-cols-5 md:grid-cols-3 sm:grid-cols-2 gap-8">
            ...
            >
              ...
              <p className="text-sm text-gray-400 leading-relaxed">
                Trusted by ambitious finance students across India, Middle East
                & beyond.
              </p>
            </motion.div>
            ...
            >
              ...
              <div className="text-xs text-gray-400 space-y-1">
                <p>
                  Exams conducted strictly at authorized global Prometric
                  centers
                </p>
